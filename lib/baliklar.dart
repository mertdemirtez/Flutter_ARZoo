...
class baliklar extends StatelessWidget {
  const baliklar({super.key});
          ...
          children: [
            Expanded(
              child: Row(
                ...
                children: [
                  getExpanded('palyaco', 'Palyaço Balığı', '', context, color: Colors.blue),
                  getExpanded('japon', 'Japon Balığı', '', context, color: Colors.red),
                ],
              ),
            ),
            Expanded(
              child: Row(
                ...
                children: [
                  getExpanded(
                      'cerrahbaligi', 'Mavi Cerrahbalığı', '', context, color: Colors.green),
                  getExpanded(
                      'melek', 'Melek Balığı', '', context, color: Colors.orange),
                ],
              ),
            ),
            Expanded(
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  getExpanded('balon', 'Balon Balığı', '', context,
                      color: Colors.purple),
                  getExpanded('fener', 'Fener Balığı', '', context,
                      color: Colors.yellow),
                ],
              ),
            ),
