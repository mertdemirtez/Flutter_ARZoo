...
class surungenler extends StatelessWidget {
  const surungenler({super.key});
          ...
          children: [
            Expanded(
              child: Row(
                ...
                children: [
                  getExpanded('iguana', 'İguana', '', context, color: Colors.blue),
                  getExpanded('yilan', 'Yılan', '', context, color: Colors.red),
                ],
              ),
            ),
            Expanded(
              child: Row(
                ...
                children: [
                  getExpanded(
                      'kertenkele', 'Kertenkele', '', context, color: Colors.green),
                  getExpanded(
                      'bukalemun', 'Bukalemun', '', context, color: Colors.orange),
                ],
              ),
            ),
            Expanded(
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  getExpanded('timsah', 'Timsah', '', context,
                      color: Colors.purple),
                  getExpanded('komodo', 'Komodo Ejderi', '', context,
                      color: Colors.yellow),
                ],
              ),
            ),
